/* Compilation Command:
[x86] gcc -o timed time_daemon_hardened.c -fstack-protector-all
[arm] ${BUILDROOT_HOME}/output/host/usr/bin/arm-linux-gcc --sysroot=${BUILDROOT_HOME}/output/staging  -c time_daemon.c -o timed
